...
$Clips = @(
    ...
    @{ Stem = "hamster_supercharged_remaining"; Text = "鼠熟"; Ssml = "<phoneme alphabet='sapi' ph='shu 3 - shu 2'>鼠熟</phoneme>"; Voice = "zh-CN-XiaoxiaoNeural"; Style = ""; VoiceParameters = "" },
    @{ Stem = "hamster_supercharged_ended"; Text = "鼠熟，已去世" },
    @{ Stem = "hamster_adrenaline_remaining"; Text = "鼠熟回血" },
    @{ Stem = "hamster_adrenaline_ended"; Text = "鼠熟回血，结束" },
